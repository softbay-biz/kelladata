...
La partie bleue s’affichera automatiquement pour la suite. Sauf la C1 concerne les enfants de 10 ans et plus.</h3>
    <div class="table">
            <div class="columns nomargin">
                <div class="column">
                      <div class="label">C0 : Membres du ménage</div>
                      <div class="select">
                          <select id="c0">
                          </select>
                       </div>
                      <div class="label">C1 : « langues lues et écrites des personnes de 10 et 20 ans dans le ménage » </div>
                      <div class="select">
                        <select id="c1">
                          <option></option>
                          <option>Bassa</option>
                      ...
                      <div class="label">C2 : A déjà fréquenté l’école ?</div>
                      <div class="select">
                            <select id="c2">
                              <option></option>
                              <option>Oui</option>
                      ...
                      <div class="label">C3 : Niveau d’étude le plus élevé</div>
                      <div class="select">
                       <select id="c3">
                        <option></option>
                 ...
                 <div class="column">
                    <div class="label">C5 : Fréquente actuellement une école ?</div>
                      ...
                      <div class="label">C6 : Type de formation</div>
                      <div class="select">
                          <select id="c6">
                            <option></option>
                      ...
                      <div class="label">C7 : Quel est le nom de l’établissement ?</div>
                       <div >
                        <input id="c7" class="input" type="text" placeholder="Text input">
                      </div>
                      <div class="label">C8 : Causes d’insatisfaction avec l’école ?</div>
                      <div class="select">
                          <select id="c8">
                            <option></option>
  ...
  <div class="q_form" id=4>
    ...
    <div class="table">
        <div class="columns nomargin">
            <div class="column">
                <div class="label">D0 : Membres du ménage âgés de plus de 4 ans  identifiés à B1</div>
                <div class="select">
                  <select id="d0">
                  </select>
                </div>
                <div class="label">D1 : Maladies/blessures comme obstacle au travail et à l’école durant les 15 derniers jours</div>
                <div class="select">
                  <select id="d1">
                    <option></option>
                    <option>Oui</option>
                ...
                <div class="label">D2 : Types de maladies/blessures durant les 15 derniers jours</div>
                <div><input id="d2" class="input" type="text" placeholder="Text input"></div>
                <div class="label">D3 : Absence au travail/école durant les 15 derniers jours</div>
                <div><input id="d3" class="input" type="text" placeholder="Text input"></div>
                <div class="label">D4 : Sollicitation des soins médicaux durant les 15 derniers jours</div>
                <div class="select">
                      <select id="d4">
                        <option></option>
            ...
            <div class="column">
                ...
                <div><input id="d5b" class="input" type="text" placeholder="Text input"></div>
                <div class="label">D6 : Problèmes rencontrés avec ledit service</div>
                <div><input id="d6" class="input" type="text" placeholder="Text input"></div>
                <div class="label">D7 : Pourquoi n’a pas consulté un service de soins</div>
                <div class="select">
                <select id="d7">
                  <option></option>
